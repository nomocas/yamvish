...
function tryExpr(func, context) {
	try {
		return func.call(context.data, context, context.env ? context.env.data.expressionsGlobal : context.data.expressionsGlobal);
	} catch (e) {
...
Interpolable.allowDelayedUpdate = false;
